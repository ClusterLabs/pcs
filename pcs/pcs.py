...
def main(argv):
    ...
    try:
        ...
        pcs_options, argv = getopt.gnu_getopt(modified_argv, "hf:p:u:", ["local","start","all","clone","cloneopt=","master","force","corosync_conf=", "defaults","debug","version","help","fullhelp","off"])
