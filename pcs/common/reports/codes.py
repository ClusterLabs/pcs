...
# force categories
FORCE = F("FORCE")
FORCE_ALERT_RECIPIENT_VALUE_NOT_UNIQUE = F("FORCE_ALERT_RECIPIENT_VALUE_NOT_UNIQUE")
FORCE_ALREADY_IN_CLUSTER = F("FORCE_ALREADY_IN_CLUSTER")
FORCE_BOOTH_DESTROY = F("FORCE_BOOTH_DESTROY")
FORCE_BOOTH_REMOVE_FROM_CIB = F("FORCE_BOOTH_REMOVE_FROM_CIB")
FORCE_REMOVE_MULTIPLE_NODES = F("FORCE_REMOVE_MULTIPLE_NODES")
FORCE_CONSTRAINT_DUPLICATE = F("FORCE_CONSTRAINT_DUPLICATE")
FORCE_CONSTRAINT_MULTIINSTANCE_RESOURCE = F("FORCE_CONSTRAINT_MULTIINSTANCE_RESOURCE")
FORCE_FILE_OVERWRITE = F("FORCE_FILE_OVERWRITE")
FORCE_LOAD_NODES_FROM_CIB = F("FORCE_LOAD_NODES_FROM_CIB")
FORCE_LOAD_THRESHOLD = F("FORCE_LOAD_THRESHOLD")
FORCE_METADATA_ISSUE = F("FORCE_METADATA_ISSUE")
FORCE_NODE_ADDRESSES_UNRESOLVABLE = F("FORCE_NODE_ADDRESSES_UNRESOLVABLE")
FORCE_NODE_DOES_NOT_EXIST = F("FORCE_NODE_DOES_NOT_EXIST")
FORCE_OPTIONS = F("FORCE_OPTIONS")
FORCE_QDEVICE_MODEL = F("FORCE_QDEVICE_MODEL")
FORCE_QDEVICE_USED = F("FORCE_QDEVICE_USED")
FORCE_QUORUM_LOSS = F("FORCE_QUORUM_LOSS")
FORCE_STONITH_RESOURCE_DOES_NOT_EXIST = F("FORCE_STONITH_RESOURCE_DOES_NOT_EXIST")
FORCE_NOT_SUITABLE_COMMAND = F("FORCE_NOT_SUITABLE_COMMAND")
FORCE_CLEAR_CLUSTER_NODE = F("FORCE_CLEAR_CLUSTER_NODE")
FORCE_RESOURCE_IN_BUNDLE_NOT_ACCESSIBLE = F("FORCE_RESOURCE_IN_BUNDLE_NOT_ACCESSIBLE")
SKIP_OFFLINE_NODES = F("SKIP_OFFLINE_NODES")
SKIP_FILE_DISTRIBUTION_ERRORS = F("SKIP_FILE_DISTRIBUTION_ERRORS")
SKIP_ACTION_ON_NODES_ERRORS = F("SKIP_ACTION_ON_NODES_ERRORS")
SKIP_UNREADABLE_CONFIG = F("SKIP_UNREADABLE_CONFIG")
...
CANNOT_BAN_RESOURCE_MASTER_RESOURCE_NOT_PROMOTABLE = M("CANNOT_BAN_RESOURCE_MASTER_RESOURCE_NOT_PROMOTABLE")
CANNOT_BAN_RESOURCE_STOPPED_NO_NODE_SPECIFIED = M("CANNOT_BAN_RESOURCE_STOPPED_NO_NODE_SPECIFIED")
CANNOT_GROUP_RESOURCE_ADJACENT_RESOURCE_FOR_NEW_GROUP = M("CANNOT_GROUP_RESOURCE_ADJACENT_RESOURCE_FOR_NEW_GROUP")
CANNOT_GROUP_RESOURCE_ADJACENT_RESOURCE_NOT_IN_GROUP = M("CANNOT_GROUP_RESOURCE_ADJACENT_RESOURCE_NOT_IN_GROUP")
CANNOT_GROUP_RESOURCE_ALREADY_IN_THE_GROUP = M("CANNOT_GROUP_RESOURCE_ALREADY_IN_THE_GROUP")
...
CANNOT_MOVE_RESOURCE_MASTER_RESOURCE_NOT_PROMOTABLE = M("CANNOT_MOVE_RESOURCE_MASTER_RESOURCE_NOT_PROMOTABLE")
CANNOT_MOVE_RESOURCE_PROMOTABLE_NOT_MASTER = M("CANNOT_MOVE_RESOURCE_PROMOTABLE_NOT_MASTER")
CANNOT_MOVE_RESOURCE_STOPPED_NO_NODE_SPECIFIED = M("CANNOT_MOVE_RESOURCE_STOPPED_NO_NODE_SPECIFIED")
CANNOT_REMOVE_ALL_CLUSTER_NODES = M("CANNOT_REMOVE_ALL_CLUSTER_NODES")
CANNOT_UNMOVE_UNBAN_RESOURCE_MASTER_RESOURCE_NOT_PROMOTABLE = M("CANNOT_UNMOVE_UNBAN_RESOURCE_MASTER_RESOURCE_NOT_PROMOTABLE")
CIB_ACL_ROLE_IS_ALREADY_ASSIGNED_TO_TARGET = M("CIB_ACL_ROLE_IS_ALREADY_ASSIGNED_TO_TARGET")
CIB_ACL_ROLE_IS_NOT_ASSIGNED_TO_TARGET = M("CIB_ACL_ROLE_IS_NOT_ASSIGNED_TO_TARGET")
...
CIB_PUSH_FORCED_FULL_DUE_TO_CRM_FEATURE_SET = M("CIB_PUSH_FORCED_FULL_DUE_TO_CRM_FEATURE_SET")
...
CIB_UPGRADE_FAILED_TO_MINIMAL_REQUIRED_VERSION = M("CIB_UPGRADE_FAILED_TO_MINIMAL_REQUIRED_VERSION")
...
CLUSTER_RESTART_REQUIRED_TO_APPLY_CHANGES = M("CLUSTER_RESTART_REQUIRED_TO_APPLY_CHANGES")
...
LIVE_ENVIRONMENT_REQUIRED_FOR_LOCAL_NODE = M("LIVE_ENVIRONMENT_REQUIRED_FOR_LOCAL_NODE")
COROSYNC_ADDRESS_IP_VERSION_WRONG_FOR_LINK = M("COROSYNC_ADDRESS_IP_VERSION_WRONG_FOR_LINK")
...
COROSYNC_CONFIG_CANNOT_SAVE_INVALID_NAMES_VALUES = M("COROSYNC_CONFIG_CANNOT_SAVE_INVALID_NAMES_VALUES")
COROSYNC_CONFIG_DISTRIBUTION_NODE_ERROR = M("COROSYNC_CONFIG_DISTRIBUTION_NODE_ERROR")
...
COROSYNC_IP_VERSION_MISMATCH_IN_LINKS = M("COROSYNC_IP_VERSION_MISMATCH_IN_LINKS")
COROSYNC_CANNOT_ADD_REMOVE_LINKS_BAD_TRANSPORT = M("COROSYNC_CANNOT_ADD_REMOVE_LINKS_BAD_TRANSPORT")
COROSYNC_CANNOT_ADD_REMOVE_LINKS_NO_LINKS_SPECIFIED = M("COROSYNC_CANNOT_ADD_REMOVE_LINKS_NO_LINKS_SPECIFIED")
COROSYNC_CANNOT_ADD_REMOVE_LINKS_TOO_MANY_FEW_LINKS = M("COROSYNC_CANNOT_ADD_REMOVE_LINKS_TOO_MANY_FEW_LINKS")
COROSYNC_LINK_ALREADY_EXISTS_CANNOT_ADD = M("COROSYNC_LINK_ALREADY_EXISTS_CANNOT_ADD")
COROSYNC_LINK_DOES_NOT_EXIST_CANNOT_REMOVE = M("COROSYNC_LINK_DOES_NOT_EXIST_CANNOT_REMOVE")
COROSYNC_LINK_DOES_NOT_EXIST_CANNOT_UPDATE = M("COROSYNC_LINK_DOES_NOT_EXIST_CANNOT_UPDATE")
...
COROSYNC_NOT_RUNNING_CHECK_NODE_ERROR = M("COROSYNC_NOT_RUNNING_CHECK_NODE_ERROR")
...
COROSYNC_OPTIONS_INCOMPATIBLE_WITH_QDEVICE = M("COROSYNC_OPTIONS_INCOMPATIBLE_WITH_QDEVICE")
COROSYNC_QUORUM_ATB_CANNOT_BE_DISABLED_DUE_TO_SBD = M("COROSYNC_QUORUM_ATB_CANNOT_BE_DISABLED_DUE_TO_SBD")
COROSYNC_QUORUM_ATB_WILL_BE_ENABLED_DUE_TO_SBD = M("COROSYNC_QUORUM_ATB_WILL_BE_ENABLED_DUE_TO_SBD")
COROSYNC_QUORUM_GET_STATUS_ERROR = M("COROSYNC_QUORUM_GET_STATUS_ERROR")
COROSYNC_QUORUM_HEURISTICS_ENABLED_WITH_NO_EXEC = M("COROSYNC_QUORUM_HEURISTICS_ENABLED_WITH_NO_EXEC")
COROSYNC_QUORUM_LOSS_UNABLE_TO_CHECK = M("COROSYNC_QUORUM_LOSS_UNABLE_TO_CHECK")
COROSYNC_QUORUM_SET_EXPECTED_VOTES_ERROR = M("COROSYNC_QUORUM_SET_EXPECTED_VOTES_ERROR")
...
COROSYNC_TRANSPORT_UNSUPPORTED_OPTIONS = M("COROSYNC_TRANSPORT_UNSUPPORTED_OPTIONS")
...
EMPTY_ID = M("EMPTY_ID") # TODO: remove
...
INVALID_ID = M("INVALID_ID") # TODO: remove
...
NODE_COMMUNICATION_COMMAND_UNSUCCESSFUL = M("NODE_COMMUNICATION_COMMAND_UNSUCCESSFUL")
NODE_COMMUNICATION_DEBUG_INFO = M("NODE_COMMUNICATION_DEBUG_INFO")
NODE_COMMUNICATION_ERROR = M("NODE_COMMUNICATION_ERROR")
NODE_COMMUNICATION_ERROR_NOT_AUTHORIZED = M("NODE_COMMUNICATION_ERROR_NOT_AUTHORIZED")
...
NODE_COMMUNICATION_ERROR_UNSUPPORTED_COMMAND = M("NODE_COMMUNICATION_ERROR_UNSUPPORTED_COMMAND")
...
PARSE_ERROR_COROSYNC_CONF_EXTRA_CHARACTERS_AFTER_OPENING_BRACE = M("PARSE_ERROR_COROSYNC_CONF_EXTRA_CHARACTERS_AFTER_OPENING_BRACE")
PARSE_ERROR_COROSYNC_CONF_EXTRA_CHARACTERS_BEFORE_OR_AFTER_CLOSING_BRACE = M("PARSE_ERROR_COROSYNC_CONF_EXTRA_CHARACTERS_BEFORE_OR_AFTER_CLOSING_BRACE")
PARSE_ERROR_COROSYNC_CONF_LINE_IS_NOT_SECTION_NOR_KEY_VALUE = M("PARSE_ERROR_COROSYNC_CONF_LINE_IS_NOT_SECTION_NOR_KEY_VALUE")
PARSE_ERROR_COROSYNC_CONF_MISSING_CLOSING_BRACE = M("PARSE_ERROR_COROSYNC_CONF_MISSING_CLOSING_BRACE")
PARSE_ERROR_COROSYNC_CONF_MISSING_SECTION_NAME_BEFORE_OPENING_BRACE = M("PARSE_ERROR_COROSYNC_CONF_MISSING_SECTION_NAME_BEFORE_OPENING_BRACE")
PARSE_ERROR_COROSYNC_CONF_UNEXPECTED_CLOSING_BRACE = M("PARSE_ERROR_COROSYNC_CONF_UNEXPECTED_CLOSING_BRACE")
PARSE_ERROR_JSON_FILE = M("PARSE_ERROR_JSON_FILE")
PCSD_VERSION_TOO_OLD = M("PCSD_VERSION_TOO_OLD")
PCSD_SSL_CERT_AND_KEY_DISTRIBUTION_STARTED = M("PCSD_SSL_CERT_AND_KEY_DISTRIBUTION_STARTED")
PCSD_SSL_CERT_AND_KEY_SET_SUCCESS = M("PCSD_SSL_CERT_AND_KEY_SET_SUCCESS")
PREREQUISITE_OPTION_MUST_BE_ENABLED_AS_WELL = M("PREREQUISITE_OPTION_MUST_BE_ENABLED_AS_WELL")
...
QDEVICE_CERTIFICATE_DISTRIBUTION_STARTED = M("QDEVICE_CERTIFICATE_DISTRIBUTION_STARTED")
QDEVICE_CERTIFICATE_REMOVAL_STARTED = M("QDEVICE_CERTIFICATE_REMOVAL_STARTED")
QDEVICE_CERTIFICATE_REMOVED_FROM_NODE = M("QDEVICE_CERTIFICATE_REMOVED_FROM_NODE")
...
QDEVICE_REMOVE_OR_CLUSTER_STOP_NEEDED = M("QDEVICE_REMOVE_OR_CLUSTER_STOP_NEEDED")
QDEVICE_USED_BY_CLUSTERS = M("QDEVICE_USED_BY_CLUSTERS")
REQUIRED_OPTIONS_ARE_MISSING = M("REQUIRED_OPTIONS_ARE_MISSING")
REQUIRED_OPTION_OF_ALTERNATIVES_IS_MISSING = M("REQUIRED_OPTION_OF_ALTERNATIVES_IS_MISSING")
RESOURCE_BAN_PCMK_ERROR = M("RESOURCE_BAN_PCMK_ERROR")
RESOURCE_BAN_PCMK_SUCCESS = M("RESOURCE_BAN_PCMK_SUCCESS")
RESOURCE_BUNDLE_ALREADY_CONTAINS_A_RESOURCE = M("RESOURCE_BUNDLE_ALREADY_CONTAINS_A_RESOURCE")
RESOURCE_BUNDLE_UNSUPPORTED_CONTAINER_TYPE = M("RESOURCE_BUNDLE_UNSUPPORTED_CONTAINER_TYPE")
RESOURCE_CLEANUP_ERROR = M("RESOURCE_CLEANUP_ERROR")
RESOURCE_DOES_NOT_RUN = M("RESOURCE_DOES_NOT_RUN")
RESOURCE_DISABLE_AFFECTS_OTHER_RESOURCES = M("RESOURCE_DISABLE_AFFECTS_OTHER_RESOURCES")
RESOURCE_FOR_CONSTRAINT_IS_MULTIINSTANCE = M("RESOURCE_FOR_CONSTRAINT_IS_MULTIINSTANCE")
...
RESOURCE_OPERATION_INTERVAL_DUPLICATION = M("RESOURCE_OPERATION_INTERVAL_DUPLICATION")
...
RESOURCE_UNMOVE_UNBAN_PCMK_EXPIRED_NOT_SUPPORTED = M("RESOURCE_UNMOVE_UNBAN_PCMK_EXPIRED_NOT_SUPPORTED")
...
SBD_DISABLING_STARTED = M("SBD_DISABLING_STARTED")
SBD_ENABLING_STARTED = M("SBD_ENABLING_STARTED")
...
SBD_WITH_DEVICES_NOT_USED_CANNOT_SET_DEVICE = M("SBD_WITH_DEVICES_NOT_USED_CANNOT_SET_DEVICE")
...
SERVICE_DISABLE_ERROR = M("SERVICE_DISABLE_ERROR")
SERVICE_DISABLE_STARTED = M("SERVICE_DISABLE_STARTED")
SERVICE_DISABLE_SUCCESS = M("SERVICE_DISABLE_SUCCESS")
SERVICE_ENABLE_ERROR = M("SERVICE_ENABLE_ERROR")
SERVICE_ENABLE_STARTED = M("SERVICE_ENABLE_STARTED")
SERVICE_ENABLE_SKIPPED = M("SERVICE_ENABLE_SKIPPED")
SERVICE_ENABLE_SUCCESS = M("SERVICE_ENABLE_SUCCESS")
SERVICE_KILL_ERROR = M("SERVICE_KILL_ERROR")
SERVICE_KILL_SUCCESS = M("SERVICE_KILL_SUCCESS")
SERVICE_NOT_INSTALLED = M("SERVICE_NOT_INSTALLED")
SERVICE_START_ERROR = M("SERVICE_START_ERROR")
SERVICE_START_SKIPPED = M("SERVICE_START_SKIPPED")
SERVICE_START_STARTED = M("SERVICE_START_STARTED")
SERVICE_START_SUCCESS = M("SERVICE_START_SUCCESS")
SERVICE_STOP_ERROR = M("SERVICE_STOP_ERROR")
SERVICE_STOP_STARTED = M("SERVICE_STOP_STARTED")
SERVICE_STOP_SUCCESS = M("SERVICE_STOP_SUCCESS")
...
UNABLE_TO_CONNECT_TO_ANY_REMAINING_NODE = M("UNABLE_TO_CONNECT_TO_ANY_REMAINING_NODE")
UNABLE_TO_CONNECT_TO_ALL_REMAINING_NODE = M("UNABLE_TO_CONNECT_TO_ALL_REMAINING_NODE")
...
UNABLE_TO_READ_COROSYNC_CONFIG = M("UNABLE_TO_READ_COROSYNC_CONFIG")
UNABLE_TO_GET_SBD_CONFIG = M("UNABLE_TO_GET_SBD_CONFIG")
UNABLE_TO_GET_SBD_STATUS = M("UNABLE_TO_GET_SBD_STATUS")
UNABLE_TO_PERFORM_OPERATION_ON_ANY_NODE = M("UNABLE_TO_PERFORM_OPERATION_ON_ANY_NODE")
WATCHDOG_INVALID = M("WATCHDOG_INVALID")
UNSUPPORTED_OPERATION_ON_NON_SYSTEMD_SYSTEMS = M("UNSUPPORTED_OPERATION_ON_NON_SYSTEMD_SYSTEMS")
...
USING_KNOWN_HOST_ADDRESS_FOR_HOST = M("USING_KNOWN_HOST_ADDRESS_FOR_HOST")
...
WAIT_FOR_IDLE_NOT_SUPPORTED = M("WAIT_FOR_IDLE_NOT_SUPPORTED")
