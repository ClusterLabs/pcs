...
STONITH_RESOURCE_TYPE_NOT_SUPPORTED_FOR_UPDATE = M(
    "STONITH_RESOURCE_TYPE_NOT_SUPPORTED_FOR_UPDATE"
)
STONITH_UNFENCING_FAILED = M("STONITH_UNFENCING_FAILED")
STONITH_UNABLE_TO_UPDATE_SCSI_DEVICES = M(
    "STONITH_UNABLE_TO_UPDATE_SCSI_DEVICES"
)
