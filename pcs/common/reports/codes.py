...
# force categories
FORCE = F("FORCE")
FORCE_ALERT_RECIPIENT_VALUE_NOT_UNIQUE = F(
    "FORCE_ALERT_RECIPIENT_VALUE_NOT_UNIQUE"
)
...
FORCE_CONSTRAINT_MULTIINSTANCE_RESOURCE = F(
    "FORCE_CONSTRAINT_MULTIINSTANCE_RESOURCE"
)
...
FORCE_STONITH_RESOURCE_DOES_NOT_EXIST = F(
    "FORCE_STONITH_RESOURCE_DOES_NOT_EXIST"
)
FORCE_NOT_SUITABLE_COMMAND = F("FORCE_NOT_SUITABLE_COMMAND")
FORCE_CLEAR_CLUSTER_NODE = F("FORCE_CLEAR_CLUSTER_NODE")
FORCE_RESOURCE_IN_BUNDLE_NOT_ACCESSIBLE = F(
...
CANNOT_MOVE_RESOURCE_PROMOTABLE_NOT_MASTER = M(
...
TAG_CANNOT_CREATE_EMPTY_TAG_NO_IDS_SPECIFIED = M("TAG_CANNOT_CREATE_EMPTY_TAG_NO_IDS_SPECIFIED")
TAG_CANNOT_REMOVE_TAG_REFERENCED_IN_CONSTRAINTS = M("TAG_CANNOT_REMOVE_TAG_REFERENCED_IN_CONSTRAINTS")
TAG_CANNOT_REMOVE_TAGS_NO_TAGS_SPECIFIED = M("TAG_CANNOT_REMOVE_TAGS_NO_TAGS_SPECIFIED")
TAG_IDS_DUPLICATION = M("TAG_IDS_DUPLICATION")
