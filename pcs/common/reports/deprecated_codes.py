...
# Removed in 1.0
# Disabling corosync encryption is no longer allowed
COROSYNC_CONFIG_DISABLING_ENCRYPTION_DEPRECATED = _D(
    "COROSYNC_CONFIG_DISABLING_ENCRYPTION_DEPRECATED"
)

# Removed in 1.0
# udp transports have been removed, only knet is left and it supports all
# options
COROSYNC_TRANSPORT_UNSUPPORTED_OPTIONS = _D(
    "COROSYNC_TRANSPORT_UNSUPPORTED_OPTIONS"
)

# Multicluster management got removed in pcs-1.0
CLUSTER_NAME_ALREADY_IN_USE = _D("CLUSTER_NAME_ALREADY_IN_USE")
NODE_NOT_IN_CLUSTER = _D("NODE_NOT_IN_CLUSTER")
UNABLE_TO_GET_CLUSTER_KNOWN_HOSTS = _D("UNABLE_TO_GET_CLUSTER_KNOWN_HOSTS")
UNABLE_TO_GET_CLUSTER_INFO_FROM_STATUS = _D(
