                    ...
                    <transient_attributes>
                        <instance_attributes>
                            ...
                            <nvpair name="last-failure-clone:1#start_0"
                                value="1528871937"/>
                            <nvpair name="fail-count-clone:2"
                                value="888"/>
                            <nvpair name="last-failure-clone:2"
                                value="1528871937"/>
                        </instance_attributes>
                    </transient_attributes>
                </node_state>
                    ...
                    <transient_attributes>
                        <instance_attributes>
                            ...
                            <nvpair name="last-failure-no-int#start_0"
                                value="an hour ago"/>
                            <nvpair name="fail-count-no-op"
                                value="42"/>
                            <nvpair name="last-failure-no-op"
                                value="1528871942"/>
                        </instance_attributes>
                    </transient_attributes>
                </node_state>
...
class ParseFailureName(TestCase):
    def test_resource(self):
        self.assertEqual(
            status._parse_failure_name("resource"),
            ("resource", None, None, None)
        )

    def test_resource_clone_id(self):
        self.assertEqual(
            status._parse_failure_name("resource:1"),
            ("resource", "1", None, None)
        )
    ...
    def test_resource_clone_id_operation(self):
        self.assertEqual(
...
class FilterResourceFailcounts(TestCase):
    ...
    def setUp(self):
        ...
        self.failures = [
            ...
            self.fail_05, self.fail_06, self.fail_07, self.fail_08,
        ]
    ...
    def test_filter_by_node(self):
        self.assertEqual(
            ...
            [self.fail_01, self.fail_02, self.fail_08]
        )
