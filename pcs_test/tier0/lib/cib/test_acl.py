...
class ValidateCreateRole(LibraryAclTest):
    def test_refuse_invalid_id(self):
        assert_report_item_list_equal(
            lib.validate_create_role(IdProvider(self.cib.tree), "#invalid"),
            [
                (
                    severities.ERROR,
    ...
    def test_refuse_existing_non_role_id(self):
        ...
        assert_report_item_list_equal(
            lib.validate_create_role(IdProvider(self.cib.tree), "node-id"),
            [
                (
                    severities.ERROR,
