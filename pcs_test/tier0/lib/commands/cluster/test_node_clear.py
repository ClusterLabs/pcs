...
class NodeClear(TestCase):
    ...
    def test_requires_live_corosync(self):
        (self.config.env.set_corosync_conf_data(_read_file("corosync.conf")))
        self.env_assist.assert_raise_library_error(
            lambda: node_clear(self.env_assist.get_env(), "nodeX"),
            [
                fixture.error(
    ...
    def test_existing_node_cib(self):
        ...
        """
        (self.config.corosync_conf.load().runner.cib.load(resources=resources))
        self.env_assist.assert_raise_library_error(
    ...
    def test_existing_node_corosync(self):
        (
            self.config.corosync_conf.load().runner.cib.load(
