    ...
    def test_default_different_results_on_different_nodes(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                {"node": "node-1", "status": default_status},
                {"node": "node-2", "status": default_status},
                {"node": "node-4", "status": default_status},
                {"node": "node-5", "status": default_status},
            ],
        )
        self.env_assist.assert_reports(
            [
                ...
                fixture.warn(
                    ...
                    node="node-2",
                    reason=(
                        "Could not resolve host: node-2; Name or service not "
                        "known"
                    ),
                    command="remote/check_sbd",
                ),
